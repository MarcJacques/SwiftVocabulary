...
class WordsTableViewController: UITableViewController {
    ...
    let variable = VocabularyWord(word: "Variable", definition: "Is a mutable property used to store various data types. The value or data can be updated. Ususally indicated by 'var.'")
